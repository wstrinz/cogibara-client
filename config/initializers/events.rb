...
WebsocketRails::EventMap.describe do
  ...
  # Uncomment and edit the next line to handle the client connected event:
    ...
    subscribe :send_file, :to => WebsocketController, :with_method => :process_file
    subscribe :send_text, :to => WebsocketController, :with_method => :send_text
    subscribe :get_new_id, :to => WebsocketController, :with_method => :get_new_id
    subscribe :set_method, :to => WebsocketController, :with_method => :set_method
    subscribe :set_language, :to => WebsocketController, :with_method => :set_language
  #
